(() => {
  ...
  const UI_COPY = {
    zh: {
      ...
      aboutImages: '所有图像是 GPT Image 2 生成的自然史插画。它们用于帮助浏览形态和类群，不应替代专业分类或野外鉴定资料。', loading: '正在整理植物谱系'
    },
    en: {
      ...
      aboutImages: 'All plates are GPT Image 2 generated natural-history illustrations for browsing morphology, not a substitute for professional classification or field guides.', loading: 'Organizing the plant lineage'
    }
  };
