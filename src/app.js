(() => {
  ...
  const UI_COPY = {
    zh: {
      ...
      aboutImages: '所有图像是 GPT Image 2 生成的自然史插画。它们用于帮助浏览形态和类群，不应替代专业分类或野外鉴定资料。', loading: '正在整理植物谱系', moreLink: '更多', footerDisclaimer: '本站内容仅供学习交流使用。转载内容版权归原著作权人所有，未经许可不得用于商业用途。如存在侵权内容，请联系站长，核实后将及时删除。访问本站即表示知悉并同意本声明。'
    },
    en: {
